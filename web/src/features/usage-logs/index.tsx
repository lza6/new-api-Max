...
import { SubscriptionLogsTable } from './components/subscription-logs-table'
import {
...
const TASK_LOG_SECTIONS = ['drawing', 'task', 'subscription'] as const
