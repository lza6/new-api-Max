...
import { Eye, EyeOff, Trash2, Copy, Building2, Unlink, Percent } from 'lucide-react'
...
import { BulkPricingDialog } from './dialogs/bulk-pricing-dialog'
    ...
    <>
      ...
      <BulkActionsToolbar table={table} entityName='model'>
        ...
        <Button
          ...
          size='icon'
          className='size-8'
          disabled={!selectedIds.length || !canEditPricing}
          title={t('Bulk set model pricing')}
          aria-label={t('Bulk set model pricing')}
